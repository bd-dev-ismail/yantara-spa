        ...
        <div className="px-4 pt-16  mx-auto container md:px-24 lg:px-8">
          <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
            <div className="">
              ...
              >
                <span className="ml-2 text-xl font-bold tracking-wide hover:text-yellow-400 text-white  uppercase">
                  Yantra Spa
                </span>
              </a>
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex">
                <p className="mr-1 text-white hover:text-yellow-400">Time:</p>
                <a
          ...
          <div className="flex flex-col-reverse justify-center pt-5 pb-10 border-t lg:flex-row">
            ...
            {/* <ul className="flex flex-col mb-3 space-y-2 lg:mb-0 sm:space-y-0 sm:space-x-5 sm:flex-row">
              <li>
                <a
                  href="#home"
                  className="text-sm text-white hover:text-yellow-400 transition-colors duration-300 hover:text-deep-purple-accent-400"
                >
                  Home
                </a>
              </li>
